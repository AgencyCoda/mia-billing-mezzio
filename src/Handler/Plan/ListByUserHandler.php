 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaPlan")
 *                  )
 *              }
 *          )
 *     ),
 ...
 */
class ListByUserHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    /**
     * 
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Billing\Repository\MiaUserPlanRepository::fetchByConfigure($configure);
